...
[
  ...
  { file_reference: 'bow_half.html',
    ...
    translation: [ 'ardha = half', 'dhanu = bow', 'āsana = posture' ],
  ...
  { file_reference: 'chair_twist_bind_up.html',
    ...
    translation: [ 'svarga = heaven', 'dvija = twice born', 'āsana = posture' ],
    category: 'Standing / Balancing',
    difficulty: 'Expert',
    description:
     [ 'From ',
  ...
  { file_reference: 'child.html',
    ...
    translation: [ 'utthita = extended', 'bala = child', 'āsana = posture' ],
  ...
  { file_reference: 'crow_side.html',
    ...
    translation: [ 'pārśva = side', 'baka = crane', 'āsana = posture' ],
    alt_name: 'Side Crane',
  ...
  { file_reference: 'deaf_man.html',
    ...
    translation: [ 'karṇa = ear', 'pīḍa = pressure', 'āsana = posture' ],
    alt_name: 'Ear Pressure',
    category: 'Arm Balance and Inversion / Forward Bend',
    difficulty: 'Expert',
    description: [ 'From a supine position, the feet come over the head and rest on the earth with the knees next to the ears and the arms extended behind the body with the fingers interlaced.  The neck is flat on the earth.  The eyes are closed.  The gaze is inward.  Take three big gulps to stimulate the thyroid.' ],
  ...
  { file_reference: 'eight_angle.html',
    ...
    translation: [ 'aṣṭā = eight', 'vakra = bent, curved', 'āsana = posture' ],
    category: 'Arm Balance and Inversion / Balancing',
    difficulty: 'Expert',
    description:
     [ 'Begin in ',
  ...
  { file_reference: 'fire_log.html',
    ...
    translation: [ 'agni = fire', 'stambha = statue', 'āsana = posture' ],
  ...
  { file_reference: 'firefly.html',
    ...
    translation: [ 'tittibha = firefly', 'āsana = posture' ],
    category: 'Arm Balance and Inversion / Balancing',
    difficulty: 'Expert',
  ...
  { file_reference: 'fish.html',
    ...
    translation: [ 'matsya = fish', 'āsana = posture' ],
    category: 'Supine / Backbend',
    difficulty: 'Intermediate',
  ...
  { file_reference: 'frog.html',
    ...
    translation: [ 'bheka = frog', 'āsana = posture' ],
    category: 'Arm and Leg Support / Neutral',
    difficulty: 'Intermediate',
    description:
     [ 'Begin from ',
  ...
  { file_reference: 'gorilla.html',
    ...
    translation: [ 'pāda = foot or leg', 'hasta = hand', 'āsana = posture' ],
  ...
  { file_reference: 'knee_pile_bind.html',
    ...
    translation: [ 'go = cow', 'mukha = face', 'āsana = posture' ],
  ...
  { file_reference: 'lotus_half.html',
    ...
    translation: [ 'ardha = half', 'padma = lotus', 'āsana = posture' ],
    category: 'Seated / Neutral',
    difficulty: 'Beginner',
    description: [ 'From a seated position, bend one knee and bring the ankle to the crease of the opposite hip so the sole of the foot faces the sky.  Bend the other knee, and cross the ankle beneath the opposite knee.  Place the hands on the thighs or knees and keep the spine straight.' ],
  ...
  { file_reference: 'plank_upward.html',
    ...
    translation: [ 'pūrva = front', 'uttānā = stretch', 'āsana = posture' ],
    category: 'Arm and Leg Support / Backbend',
    difficulty: 'Intermediate',
    description:
     [ 'From ',
  ...
  { file_reference: 'rabbit.html',
    ...
    translation: [ 'sasanga = rabbit', 'āsana = posture' ],
    category: 'Arm and Leg Support / Forward Bend',
    difficulty: 'Beginner',
    description:
     [ 'From ',
  ...
  { file_reference: 'scale.html',
    ...
    translation: [ 'tola = scale', 'āsana = posture' ],
    category: 'Arm Balance and Inversion / Balancing',
    difficulty: 'Intermediate',
    description: [ 'The palms press into the earth, supporting the weight of the body with the elbows straight.  The legs are wrapped around the elbows, extended forward and hooked at the ankles with the feet lifted into the full expression of the pose.  The ribcage is lifted.  The gaze is forward.' ],
    benefits: 'Strengthens arms and wrists.  Improves focus and concentration.  Opens flexibility of lower body.' },
  ...
  { file_reference: 'seated_on_heels_twist_bound.html',
    ...
    translation: [ 'pāśa = noose', 'asana = posture' ],
    category: 'Seated / Twist',
    difficulty: 'Expert',
    description:
     [ 'From ',
  ...
  { file_reference: 'standing_hand_to_toe.html',
    ...
    translation: [ 'hasta = hand', 'pādāṅguṣṭha = big toe', 'āsana = posture' ],
    category: 'Standing / Balancing',
    difficulty: 'Expert',
    description:
     [ 'From ',
  ...
  { file_reference: 'supine_bound_angle.html',
    ...
    category: 'Supine / Neutral',
    difficulty: 'Beginner',
    description: [ 'In supine position, bend both knees and drop the knees to each side, opening the hips.  Bring the soles of the feet together and bring the heels as close to the groin as possible, keeping the knees close to the ground.  Bring the hands overhead and interlace the fingers.  Keep the back flat on the floor.' ],
    benefits: 'Opens the hips and groins.  Stretches the shoulders, rib cage and back.  Stimulates the abdominal organs, lungs and heart.' },
  { file_reference: 'supine_hand_to_toe.html',
    ...
    category: 'Supine / Neutral',
    difficulty: 'Intermediate',
    description: [ 'In supine position, raise one leg to the sky.  Using the hand from the same side, catch the toes to bring the knee closer to the chest, straightening the knee.  Make sure the gluts and the other legs are rested on the floor.  If the hand cannot reach the toes, use a strap.' ],
  ...
  { file_reference: 'supine_spinal_twist.html',
    ...
    difficulty: 'Beginner',
    description: [ 'From supine position, bent one knee and cross it outside of the opposite foot.  Use the hand to put slight pressure on the bent knee to push down towards the floor.  Keep both shoulders squared and rooted to the floor.  Extend the opposite hand and gaze towards the hand.  For a deeper stretch, start to straighten the bent knee.' ],
  ...
  { file_reference: 'tortoise_bind.html',
    ...
    translation: [ 'kūrma = tortoise', 'āsana = posture' ],
    category: 'Standing / Forward Bend',
    difficulty: 'Expert',
    description:
     [ 'From ',
  ...
  { file_reference: 'turtle.html',
    ...
    translation: [ 'pavana = wind', 'mukta = releasing', 'āsana = posture' ],
    alt_name: 'Supine Knees to Chest',
    category: 'Supine / Forward Bend',
    difficulty: 'Beginner',
    description: [ 'From a supine position, lying on your back, the knees are bent and pulled into the chest.  The arms are wrapped around the knees with the chin tucked in towards the sternum like a turtle going into its shell.  The gaze is inward.' ],
  ...
  { file_reference: 'wind_removing.html',
    ...
    category: 'Supine / Forward Bend',
    difficulty: 'Beginner',
    description: [ 'From a supine position lying on your back, pull one knee into the chest with the hands clasped around the bent knee to the level of pressure desired (gas trapped in the large intestine may be released in this asana).  The other leg is extended straight and the gaze is natural and forward.' ],
